...
├── skills/
│   ├── news-card/                   # Main skill: AI news digest
...
│   │   ├── references/              # Spec docs (sources, scoring, components, density, design)
...
│   ├── XHS-writer/                  # Xiaohongshu note writing skill
│   │   └── SKILL.md
│   └── autoresearch/                # Meta-skill: auto-optimize other skills
│       └── SKILL.md
