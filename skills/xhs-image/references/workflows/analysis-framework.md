...
description: Content analysis framework for XHS engagement optimization
---
...
|----------|---------|---------------|
| **Cover** | Stop scrolling | 最强视觉冲击 + 核心标题 |
| **Setup** | Build context | 痛点共鸣 / 好奇心 |
| **Core** | Deliver value | 干货内容，每页1-2个要点 |
| **Payoff** | Practical takeaway | 可执行的行动建议 |
| **Ending** | Drive action | CTA + 互动引导 |
...
1. Style + Layout 推荐 1 (recommended)
2. Style + Layout 推荐 2
3. Style + Layout 推荐 3
```
...
- [ ] Is the hook strong enough? (at least 3 stars)
